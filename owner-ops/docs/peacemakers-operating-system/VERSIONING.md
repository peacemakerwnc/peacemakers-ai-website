...
| Peacemakers Blueprint Advisor skill | `blueprint-advisor-x.y.z` in skill frontmatter/body; record compatible `pm-os-x.y.z` (current: `blueprint-advisor-0.1.0` / `pm-os-0.1.0`) |
